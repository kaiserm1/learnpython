...
"""
    Diagonale für 4 zusammenhängende Zahlen: spalten - 3, zeilen - 3 jeweils
    links und rechts und oben und unten

            grid[0][3]         grid[0][16]
        grid[3][0]                 grid[3][19]

        grid[16][0]                grid[16][19]
            grid[19][3]        grid[19,16]
"""
...
def calculate_greatest_product(sequence_input):
    pass
